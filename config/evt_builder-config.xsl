...
<xsl:stylesheet xpath-default-namespace="http://www.tei-c.org/ns/1.0"
	...
	<xsl:param name="index_title" select="'Preface to Ælfrics First Series of Catholic Homilies'"/>
...
<div>
	...
	<xsl:variable name="lists" as="element()*">
		...
		<group label="OTHERS" active="false">
			<seg type="kenning" active="false" label="KENNING"/>
		</group>
	</xsl:variable>
